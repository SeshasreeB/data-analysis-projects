CREATE TABLE Sep2025JunkDB.sree_krishnamurthy.book
(
...
select *
FROM Sep2025JunkDB.sree_krishnamurthy.book
INSERT INTO Sep2025JunkDB.sree_krishnamurthy.book
    (author_id, title, isbn, available, genre_id)
VALUES
    (2, 'A Midsummers Night Dream', 978149413, 1, 23)
...
drop table Sep2025JunkDB.sree_krishnamurthy.author


INSERT INTO Sep2025JunkDB.sree_krishnamurthy.author
    (first_name, last_name, birth_year, death_year)
VALUES
    ('Phillip', 'Pullman', 1946, null);
...
CREATE TABLE Sep2025JunkDB.sree_krishnamurthy.patron
(
...
INSERT INTO Sep2025JunkDB.sree_krishnamurthy.patron
    (first_name, last_name, loan_id)
VALUES
    ('Jennifer', 'Slayny', NULL);
...
VALUES
    ('Oliver', 'Caulson', NULL);
CREATE TABLE Sep2025JunkDB.sree_krishnamurthy.genre
(
    genre_id INT PRIMARY KEY,
    genres VARCHAR(100)
);
-- populating genre table
INSERT INTO Sep2025JunkDB.sree_krishnamurthy.genre
    (genre_id, genres)
VALUES
    (1, 'Fantasy');
...
VALUES
    (26, 'Poetry');
CREATE TABLE Sep2025JunkDB.sree_krishnamurthy.loan
(
    ...
    date_in DATE,
    book_id INT
        CONSTRAINT book_id FOREIGN KEY (book_id) REFERENCES Sep2025JunkDB.sree_krishnamurthy.book (book_id)
        ON UPDATE SET NULL
        ON DELETE SET NULL
);
...
SELECT b.title, a.first_name + ' ' + a.last_name AS authors_name
FROM Sep2025JunkDB.sree_krishnamurthy.book b
    INNER JOIN Sep2025JunkDB.sree_krishnamurthy.author a ON b.author_id = a.author_id
WHERE a.death_year IS NULL

UPDATE Sep2025JunkDB.sree_krishnamurthy.book
SET available=0
WHERE book_id=1
...
INSERT INTO Sep2025JunkDB.sree_krishnamurthy.loan
    (patron_id, date_out, book_id)
VALUES(1, GETDATE(), 1);
select *
from Sep2025JunkDB.sree_krishnamurthy.loan

UPDATE Sep2025JunkDB.sree_krishnamurthy.patron
SET loan_id = 1
WHERE patron_id = 1;
SELECT *
FROM Sep2025JunkDB.sree_krishnamurthy.patron
...
FROM Sep2025JunkDB.sree_krishnamurthy.book
SELECT*
FROM Sep2025JunkDB.sree_krishnamurthy.genre
SELECT*
FROM Sep2025JunkDB.sree_krishnamurthy.patron
SELECT*
FROM Sep2025JunkDB.sree_krishnamurthy.loan
...
Create a query that returns the names of the patrons
with the genre of every book they currently have checked out.
-- SELECT first_name,last_name FROM Sep2025JunkDB.sree_krishnamurthy.patron as p
-- INNER JOIN Sep2025JunkDB.sree_krishnamurthy.loan as l
...
FROM Sep2025JunkDB.sree_krishnamurthy.loan l

    INNER JOIN Sep2025JunkDB.sree_krishnamurthy.patron p ON l.patron_id = p.patron_id

    INNER JOIN Sep2025JunkDB.sree_krishnamurthy.book b ON l.book_id = b.book_id

    INNER JOIN Sep2025JunkDB.sree_krishnamurthy.genre g ON g.genre_id = b.genre_id

WHERE available =0 AND date_in is NULL
CREATE TABLE Sep2025JunkDB.sree_krishnamurthy.reference_books
(
    reference_id INT IDENTITY(1,1) PRIMARY KEY,
    edition INT,
    book_id INT,
    book_id INT FOREIGN KEY REFERENCES Sep2025JunkDB.sree_krishnamurthy.book(book_id)
        ON UPDATE SET NULL
        ON DELETE SET NULL
);